...
export function ThemeToggle() {
    ...
    if (!mounted) {
        return (
            <button className="flex items-center gap-3 w-full rounded-2xl border border-zinc-200 dark:border-zinc-800 px-3 py-3 text-sm bg-zinc-100 dark:bg-zinc-950/90 text-zinc-500 dark:text-zinc-400" aria-label="Toggle theme">
                ...
                <div className="min-w-0 flex-1 text-left">
                    <div className="text-[11px] uppercase tracking-[0.22em] text-zinc-400 dark:text-zinc-500">Thème</div>
                    <div className="mt-0.5 font-medium text-zinc-700 dark:text-zinc-200">Sombre</div>
                </div>
            </button>
        );
    }
    ...
    return (
        ...
        >
            ...
            <div className="min-w-0 flex-1 text-left">
                <div className="text-[11px] uppercase tracking-[0.22em] text-zinc-400 dark:text-zinc-500">Thème</div>
                <div className="mt-0.5 font-medium">{isDark ? "Sombre" : "Clair"}</div>
            </div>
        </button>
    );
}
